		...
		<?php endif; ?>
					...
					<?php if ( ! has_custom_logo() ) { ?>
						...
						<?php if ( is_front_page() && is_home() ) : ?>
							...
							<h1 class="navbar-brand mb-0 text-uppercase"><a rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" itemprop="url"><?php bloginfo( 'name' ); ?></a></h1>

						<?php else : ?>

							<a class="navbar-brand text-uppercase" rel="home" href="<?php echo esc_url( home_url( '/' ) ); ?>" itemprop="url"><?php bloginfo( 'name' ); ?></a>

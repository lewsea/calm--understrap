<?php
/**
 * The template for displaying the footer secondary
 *
...
<div class="project-cta">
	<div class="container">
		<h3>We would love to hear your fresh ideas !</h3>
		<a href="" class="accent-btn">Start your project</a>
	</div>
</div>
